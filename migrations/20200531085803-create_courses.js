    ...
    await db.collection('courses').insertMany([
  		{
  			...
  			subjects: [ "5ed9be83aafaf27442b80d11", "5ed9be83aafaf27442b80d12"],
  			// students: [0, 4],
  		...
  		},
  		{
  			...
  			subjects: ["5ed9be83aafaf27442b80d13", "5ed9be83aafaf27442b80d14"],
  			// students: [4],
  		...
  		},
  		{
  			...
  			subjects: ["5ed9be83aafaf27442b80d15", "5ed9be83aafaf27442b80d16"],
  			// students: [7, 8],
  		...
  		},
  		{
  			...
  			subjects: ["5ed9be83aafaf27442b80d17", "5ed9be83aafaf27442b80d18"],
			// students: [9, 7],
